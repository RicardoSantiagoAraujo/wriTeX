...
\newcommand{\isPortfolio}[2]{%
  \ifthenelse{\equal{\jobname}{\detokenize{portfolio_document}}} % /!\ need to address the expanded version too
  {#1}
  {#2}
}%
...
\newcommand{\isArticle}[2]{%
  \ifthenelse{\equal{\jobname}{\detokenize{document}}} % /!\ need to address the expanded version too 
  {#1}
  {#2}
}%
...
\myArticleSection{Section}
\lipsum[1]

\myArticleSubsection{Subsection}
\lipsum[2]

\myArticleSubsubsection{Subsubsection}
\lipsum[3]
