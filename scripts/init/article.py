...
def main():
    ...
    print_progress_msg(f"Renamed files inside new folder as {bold+green}{new_article_name}{reset}")

    # Remove template build folder and files
    delete_build(new_folder)
    print_progress_msg(f"Removed old build folder {bold+green}{build_folder}{reset} from new article")

    # Remove template markdown auxiliary files
    delete_md_aux(new_folder)
    print_progress_msg(f"Removed old {bold+green}_markdown{reset} folder from new article ")

    # Remove template expanded files
    delete_expanded(ThingType("Article").value, new_folder)
    print_progress_msg(f"Removed old {bold+green}expanded{reset} file from new article ")
...
def create_new_bib_entry(new_thing_name: str, old_thing_name: str, new_folder: str) -> None:
    print("\n\n📚📚📚📚📚📚📚📚📚📚📚📚📚📚📚📚📚📚📚📚📚📚📚📚📚📚📚📚📚📚📚📚📚📚")
    print(f"Would you also like to create a new {blue}biblatex{reset} entry for {green+bold}{new_thing_name}{reset} ?")
