...
\input{./../../portfolio_only_files/portfolio_constants/portfolio_constants.tex}
\usepackage{xifthen}
\renewcommand{\wrtxLanguagePortfolio}{en}% select languague to be used in portfolio
...
\renewcommand{\portfolioTitleImg}{../../../articles/wrtx_article_template/assets/figures/example-image.jpg}
...
wrtx_article_template,% article template that you can use as a base for yours
wrtx_article_tutorial,% example article for demonstration
}%
...
{% leave no spaces to be able to detect when list is empty
  ../../../../../articles/wrtx_article_template/elements/appendix/appendix_a,%
  mock_certificate,%
}
